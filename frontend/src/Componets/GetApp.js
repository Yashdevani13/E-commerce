    ...
    return (
        <>
            <section className='flexCenter w-full flex-col' id='app'>
                <div className='mx-auto max-w-[1440px] relative flex w-full flex-col justify-between gap-32 
                overflow-hidden px-6 py-12 sm:flex-row sm:gap-12 sm:py-24 lg:px-20 xl:max-h-[598px] 2xl:rounded-5xl bg-primary'>
                    <div className='flex w-full flex-1 flex-col items-start justify-center gap-4 xl:max-w-[555px]'>
                        <h2 className=' bold-40 lg:bold-60'>Get our app now!</h2>
                        ...
                        <p className='py-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Unde repellendus numquam voluptate, maiores officia nulla
                            at nostrum doloremque officiis, nisi corporis dolor.
                        </p>
