      ...
      <section className='max-padd-container pt-20'>
        <div className='py-10'>
          <table className='w-full'>
            <thead>
              <tr className='border-b border-s-slate-900/20 text-gray-300 regular-14 xs:regular-16 text-start py-12'>
            ...
            <tbody>
              {all_products.map((product) => {
                if (cartItems[product._id] > 0) {
                  return (
                    <tr key={product._id} className='border-b border-s-lime-900/20 text-gray-50 p-6 medium-14 text-left '>
                      <td>
